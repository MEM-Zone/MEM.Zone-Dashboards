        ...
        IF @HelperFunctionExists = 1
            BEGIN
                INSERT INTO @MaintenanceInfo(ResourceID, NextServiceWindow, ServiceWindowStart, ServiceWindowDuration, IsServiceWindowEnabled, IsServiceWindowOpen, IsUTCTime)
                    ...
                    FROM [dbo].[fn_rbac_FullCollectionMembership](@UserSIDs) AS CollectionMembers
                        OUTER APPLY [dbo].[ufn_CM_GetNextMaintenanceWindowForDevice](CollectionMembers.ResourceID) AS NextServiceWindow
