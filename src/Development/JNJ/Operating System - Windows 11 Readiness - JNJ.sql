...
--DECLARE @Thresholds               AS NVARCHAR(20)  = 'SMS0001';
...
SELECT SubString FROM fn_SplitString(@CompatibleProcessorsList, ';'); -- Stupidity Workaround
...
SELECT SubString FROM fn_SplitString(@Thresholds, N',') -- Stupidity Workaround
