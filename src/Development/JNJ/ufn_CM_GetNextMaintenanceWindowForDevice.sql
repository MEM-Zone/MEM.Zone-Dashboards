...
.EXAMPLE
    SELECT dbo.ufn_CM_DeviceNextMaintenanceWindow@UserSIDs,16777216)
.NOTES
    Requires SQL 2016.
...
--IF OBJECT_ID('[dbo].[ufn_CM_DeviceNextMaintenanceWindow]') IS NOT NULL
--    BEGIN
--        DROP FUNCTION [dbo].[ufn_CM_DeviceNextMaintenanceWindow]
--    END
--GO
/* #endregion */

/* #region create ufn_CM_DeviceNextMaintenanceWindow */
CREATE FUNCTION [dbo].[ufn_CM_DeviceNextMaintenanceWindow] (
