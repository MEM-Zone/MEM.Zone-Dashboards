...
RETURNS @OSInfo TABLE (
    ...
    BEGIN
        ...
        INSERT INTO @OSInfo (ResourceID, Version, ServicingStateNumber, ServicingStateName)
            ...
            FROM CM_JNJ.dbo.fn_GetWindowsServicingStates() AS OSServicingStates
                JOIN CM_JNJ.dbo.fn_GetWindowsServicingLocalizedNames() AS OSLocalizedNames ON OSLocalizedNames.Name = OSServicingStates.Name
...
select SMS_R_System.ResourceId, SMS_R_System.ResourceType, SMS_R_System.Name, SMS_R_System.SMSUniqueIdentifier, SMS_R_System.ResourceDomainORWorkgroup, SMS_R_System.Client from  SMS_R_System inner join SMS_G_System_OPERATING_SYSTEM on SMS_G_System_OPERATING_SYSTEM.ResourceID = SMS_R_System.ResourceId where SMS_R_System.OperatingSystemNameandVersion like "Microsoft Windows NT Workstation 10.0%" or SMS_R_System.OperatingSystemNameandVersion like "Windows Workstation 10.0%" and (SMS_G_System_OPERATING_SYSTEM.Caption like "Microsoft Windows 10 Pro%" or SMS_G_System_OPERATING_SYSTEM.Caption in ("Microsoft Windows 10 专业版","Microsoft Windows 10 專業版"))